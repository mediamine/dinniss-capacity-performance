...
-- =============================================================================
-- Run AFTER 010_create_views.sql, 021_create_materialized_views.sql, and 026_create_materialized_views.sql
...
--   2. 3_Staff_Performance_Table       (depends on #1, 2_Staff_Task_Allocation_byDay from 026, 4_Timesheet_Table from 025, EXCEL01_Staff_Workable_Days from 021, EXCEL05_Staff_Adjustment_Sheet from 021, excel07_staff_incentive+target_hours from 021)
-- =============================================================================
...
-- Dependencies: 3_Staff_Performance_Table_base, 2_Staff_Task_Allocation_byDay (from 026),
--               EXCEL01_Staff_Workable_Days (from 021), EXCEL05_Staff_Adjustment_Sheet (from 021)
--
-- Columns added:
