...
--   4. TOCHECK_Invoice                     (depends on invoice base table, key06_job_table from 010_create_materialized_views.sql)
...
-- Dependencies: invoice base table, key06_job_table (from 010_create_materialized_views.sql)
DROP MATERIALIZED VIEW IF EXISTS TOCHECK_Invoice CASCADE;
